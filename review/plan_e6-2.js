...
(window.QR_BASE_PLANS = window.QR_BASE_PLANS || []).push({ key:'e6-2_2026-09-22c', data:{
"format": "qr-plan-2",
"grade": "e6-2",
"rounds": 3,
"items": [
...
"small": "01. 분모가 같은 (분수)÷(분수)(1)·나누어떨어지는 경우",
"kind": "low",
"newQ": "4/5 ÷ 1/5은 무엇을 세어서 구해?",
"newQBy": "claude",
"qWas": "4/5 ÷ 1/5는 무엇을 세어서 구해?",
"by": "claude"
},
{
"id": "4tqc50:t0H2",
...
"small": "01. 분모가 같은 (분수)÷(분수)(1)·나누어떨어지는 경우",
"kind": "high",
"newQ": "8/9 ÷ 1/9과 8/9 ÷ 2/9 중 어느 몫이 더 큰지, 계산하지 않고 이유로 말해 봐.",
"newQBy": "claude",
"qWas": "8/9 ÷ 1/9와 8/9 ÷ 2/9 중 어느 몫이 더 큰지, 계산하지 않고 이유로 말해 봐.",
"by": "claude"
},
{
"id": "4tqc50:qerror",
...
"small": "01. 분모가 같은 (분수)÷(분수)(1)·나누어떨어지는 경우",
"kind": "qset",
"newQ": "친구가 6/7 ÷ 2/7를 분모끼리도 나눠서 3/1이라고 했어. 뭐가 잘못됐는지 찾고, 바른 답도 말해 봐.",
"newQBy": "claude",
"qWas": "친구가 6/7 ÷ 2/7을 분모끼리도 나눠서 3/1이라고 했어. 뭐가 잘못됐는지 찾고, 바른 답도 말해 봐.",
"by": "claude"
},
{
"id": "4tqc50:qa22e6211",
...
"small": "02. 분모가 같은 (분수)÷(분수)(2)·나누어떨어지지 않는 경우",
"kind": "high",
"newQ": "5/8 안에 2/8가 2번 들어가고 반이 남아. 이게 5/8 ÷ 2/8 = 2와 1/2과 어떻게 이어지는지 말해 봐.",
"newQBy": "claude",
"qWas": "5/8 안에 2/8이 2번 들어가고 반이 남아. 이게 5/8 ÷ 2/8 = 2와 1/2과 어떻게 이어지는지 말해 봐.",
"answer": "2/8가 2번 들어가서 2이고, 남은 1/8은 2/8의 반이라서 1/2이야. 그래서 몫이 2와 1/2이야.",
"keys": [
"2번 들어가서 2",
"남은 1/8은 2/8의 반"
],
"answerBy": "claude",
"ansWas": {
"a": "2/8이 2번 들어가서 2이고, 남은 1/8은 2/8의 반이라서 1/2이야. 그래서 몫이 2와 1/2이야.",
"k": [
"2번 들어가서 2",
"남은 1/8은 2/8의 반"
]
...
"small": "03. 분모가 다른 (분수)÷(분수)",
"kind": "high",
"answer": "2/3를 6/9로 통분하면 6/9 ÷ 2/9야. 분자끼리 6 ÷ 2 = 3이야.",
"keys": [
"6/9 ÷ 2/9로 통분",
"6 ÷ 2 = 3"
],
"answerBy": "claude",
"ansWas": {
"a": "2/3을 6/9로 통분하면 6/9 ÷ 2/9야. 분자끼리 6 ÷ 2 = 3이야.",
"k": [
"6/9 ÷ 2/9로 통분",
"6 ÷ 2 = 3"
]
...
"small": "05. (분수)÷(분수)를 분수의 곱셈으로 나타내기",
"kind": "high",
"newQ": "5/7 ÷ 3/4을 분수의 곱셈으로 바꿔 계산하는 과정을 말해 봐.",
"newQBy": "claude",
"qWas": "5/7 ÷ 3/4를 분수의 곱셈으로 바꿔 계산하는 과정을 말해 봐.",
"by": "claude"
},
{
"id": "1jx91nq:t0H2",
...
"small": "05. (분수)÷(분수)를 분수의 곱셈으로 나타내기",
"kind": "high",
"newQ": "어떤 수를 4/7로 나누었더니 2/3가 됐어. 어떤 수는 어떻게 구해?",
"newQBy": "claude",
"qWas": "어떤 수를 4/7로 나누었더니 2/3이 됐어. 어떤 수는 어떻게 구해?",
"by": "claude"
},
{
"id": "1jx91nq:qerror",
...
"small": "05. (분수)÷(분수)를 분수의 곱셈으로 나타내기",
"kind": "qset",
"newQ": "친구가 5/7 ÷ 3/4을 앞의 분수를 뒤집어서 7/5 × 3/4라고 했어. 뭐가 잘못됐는지 찾고, 바른 식도 말해 봐.",
"newQBy": "claude",
"qWas": "친구가 5/7 ÷ 3/4를 앞의 분수를 뒤집어서 7/5 × 3/4라고 했어. 뭐가 잘못됐는지 찾고, 바른 식도 말해 봐.",
"answer": "분모와 분자를 바꾸는 건 나누는 분수야. 5/7 × 4/3가 바른 식이야.",
"keys": [
"나누는 분수를 바꾼다",
"5/7 × 4/3"
],
"answerBy": "claude",
"ansWas": {
"a": "분모와 분자를 바꾸는 건 나누는 분수야. 5/7 × 4/3이 바른 식이야.",
"k": [
"나누는 분수를 바꾼다",
"5/7 × 4/3"
]
...
"small": "03. 비례식을 알아볼까요",
"kind": "qset",
"answer": "두 비의 비율을 구해서 같은지 봐. 3/4과 9/12 = 3/4로 같으니까 3 : 4 = 9 : 12로 세울 수 있어.",
"keys": [
"비율을 비교한다",
"둘 다 3/4"
],
"answerBy": "claude",
"ansWas": {
"a": "두 비의 비율을 구해서 같은지 봐. 3/4와 9/12 = 3/4로 같으니까 3 : 4 = 9 : 12로 세울 수 있어.",
"k": [
"비율을 비교한다",
"둘 다 3/4"
]
...
"small": "06. 비례배분을 해 볼까요",
"kind": "high",
"answer": "2 : 3으로 나누면 전체가 5몫이고 그중 2몫, 3몫을 가져. 그래서 전체의 2/5, 3/5을 곱해.",
"keys": [
"전체가 합만큼의 몫",
"각각 2/5, 3/5"
],
"answerBy": "claude",
"ansWas": {
"a": "2 : 3으로 나누면 전체가 5몫이고 그중 2몫, 3몫을 가져. 그래서 전체의 2/5, 3/5를 곱해.",
"k": [
"전체가 합만큼의 몫",
"각각 2/5, 3/5"
]
...
/* [pre] 2026-09-23 🌱 선수 개념 질문 — 앞 학년·앞 단원에서 배운 것을 확인하는 1회차 질문 (마스터 요청).
   소단원 맨 앞(ord 0)에 놓는다. 어른 화면 구분 표시는 review/pre_e6-2.js 의 window.QR_PRE.
   원천 작업도구/질문계단/make_pre.py */
(window.QR_BASE_PLANS = window.QR_BASE_PLANS || []).push({ key:'e6-2_pre_2026-09-23', data:{
"format": "qr-plan-2",
"grade": "e6-2",
"rounds": 3,
"items": [
...
"small": "01. 분모가 같은 (분수)÷(분수)(1)·나누어떨어지는 경우",
"kind": "add",
"q": "4/5는 1을 똑같이 몇으로 나눈 것 중에 몇 개라는 뜻이야?",
"round": 1,
"ord": 0,
"answer": "1을 똑같이 5로 나눈 것 중에 4개라는 뜻이야.",
"keys": [
"똑같이 5로 나눈다",
"그중 4개"
],
...
"round": 1,
"ord": 0,
"answer": "분자끼리, 분모끼리 곱해. 2 × 4 = 8, 3 × 5 = 15라서 8/15야.",
"keys": [
"분자끼리·분모끼리 곱한다",
"8/15"
],
...
"small": "06. 분수의 나눗셈을 계산해 볼까요·(대분수)÷(분수)",
"kind": "add",
"q": "2와 1/3을 가분수로 바꾸면 얼마야?",
"round": 1,
"ord": 0,
"answer": "자연수 2는 6/3이니까 6/3 + 1/3 = 7/3이야.",
"keys": [
"자연수를 분수로 바꾼다",
"7/3"
],
...
{
"id": "1f2rp7u:qapre0201",
"big": "2. 소수의 나눗셈",
"small": "01. (소수 한 자리 수)÷(소수 한 자리 수)",
"kind": "add",
"q": "0.4를 10배 하면 얼마야? 어떻게 알 수 있어?",
"round": 1,
"ord": 0,
"answer": "소수점이 오른쪽으로 한 칸 옮겨져서 4가 돼.",
"keys": [
"소수점이 오른쪽으로 한 칸",
"4"
],
...
"small": "05. 몫을 반올림하여 나타내 볼까요",
"kind": "add",
"q": "3.27을 반올림하여 소수 첫째 자리까지 나타내면 얼마야?",
"round": 1,
"ord": 0,
"answer": "바로 아래 자리인 소수 둘째 자리가 7이라 5보다 크니까 올려서 3.3이야.",
"keys": [
"바로 아래 자리를 본다",
"3.3"
],
...
"round": 1,
"ord": 0,
"answer": "뒤의 5가 기준량이고 앞의 3이 비교하는 양이니까 3/5야.",
"keys": [
"뒤가 기준량",
"3/5"
],
...
"small": "02. 간단한 자연수의 비로 나타내 볼까요",
"kind": "add",
"q": "12 : 18을 더 간단하게 만들려면 두 수를 무엇으로 나누면 돼?",
"round": 1,
"ord": 0,
"answer": "12와 18의 최대공약수 6으로 나누면 2 : 3이 돼.",
"keys": [
"최대공약수로 나눈다",
"2 : 3"
],
...
"small": "01. 원주와 원주율을 알아볼까요",
"kind": "add",
"q": "반지름이 5 cm인 원의 지름은 몇 cm야? 왜 그래?",
"round": 1,
"ord": 0,
"answer": "지름은 반지름의 2배니까 10 cm야.",
"keys": [
"지름 = 반지름 × 2",
"10 cm"
],
...
"small": "04. 원의 넓이를 구하는 방법을 알아볼까요",
"kind": "add",
"q": "가로가 8 cm, 세로가 5 cm인 직사각형의 넓이는 몇 cm²야?",
"round": 1,
"ord": 0,
"answer": "가로 × 세로니까 8 × 5 = 40 cm²야.",
"keys": [
"가로 × 세로",
"40 cm²"
],
...
"small": "01. 원기둥을 알아볼까요",
"kind": "add",
"q": "각기둥의 밑면은 몇 개이고, 옆면은 어떤 모양이야?",
"round": 1,
"ord": 0,
"answer": "밑면은 2개이고 서로 평행해. 옆면은 모두 직사각형이야.",
"keys": [
"밑면 2개",
"옆면은 직사각형"
],
...
"small": "03. 원뿔을 알아볼까요",
"kind": "add",
"q": "각뿔의 밑면은 몇 개이고, 옆면은 어떤 모양이야?",
"round": 1,
"ord": 0,
"answer": "밑면은 1개이고, 옆면은 모두 삼각형이야.",
"keys": [
"밑면 1개",
"옆면은 삼각형"
],
...
(window.QR_BASE_PLANS = window.QR_BASE_PLANS || []).push({ key:'e6-2_2026-09-23c', data:{
"format": "qr-plan-2",
"grade": "e6-2",
"rounds": 3,
"items": [
...
"small": "01. 어느 방향에서 보았는지 알아볼까요",
"kind": "low",
"newQ": "② 사진을 어느 방향에서 찍었는지는 무엇을 보고 알 수 있을까?",
"qWas": "② 사진을 어느 방향에서 찍었는지는 무엇을 보고 알 수 있을까? (보이는 물체의 순서와 위치)",
"ok": true,
"by": "claude"
},
{
...
"small": "03. 쌓은 모양과 쌓기나무의 개수(2)·위·앞·옆에서 본 모양",
"kind": "low",
"newQ": "앞에서 본 모양을 그릴 때 어떻게 그려야 하지?",
"qWas": "앞에서 본 모양을 그릴 때 각 줄에서 몇 층까지 그려?",
"ok": true,
"by": "claude"
},
{
...
"offWas": true,
"ok": true,
"answer": "그 줄에 있는 자리 중 적어도 한 자리는 2층으로 쌓여 있다는 뜻이야.",
"keys": [
...
"small": "01. 어느 방향에서 보았는지 알아볼까요",
"kind": "add",
"q": "상자 세 개를 그림처럼 놓았어. 앞에서 볼 때와 오른쪽 옆에서 볼 때 가장 앞에 보이는 상자는 각각 무슨 색이야?",
"round": 1,
"ord": 0,
"answer": "앞에서 보면 빨강 상자가, 오른쪽 옆에서 보면 초록 상자가 가장 앞에 보여.",
"keys": [
"앞에서는 빨강",
"오른쪽 옆에서는 초록"
],
...
"small": "01. 어느 방향에서 보았는지 알아볼까요",
"kind": "add",
"q": "같은 그림에서 앞에서 볼 때 파랑 상자는 빨강 상자에 완전히 가려질까? 왜 그런지 말해 봐.",
"round": 2,
"ord": 1,
"answer": "완전히 가려지지는 않아. 파랑 상자는 2층 높이라서 아래쪽만 빨강 상자에 가려지고 위쪽은 보여.",
"keys": [
"같은 줄에 앞뒤로 있다",
"파랑이 더 높아서 위쪽은 보인다"
],
...
"small": "01. 어느 방향에서 보았는지 알아볼까요",
"kind": "add",
"q": "친구가 이 모양을 앞에서 보면 초록 상자가 가장 앞에 보인다고 했어. 뭐가 잘못됐는지 찾고, 바르게 말해 봐.",
"round": 2,
"ord": 2,
"answer": "초록 상자는 가장 뒷줄에 있어. 앞에서 보면 가장 앞줄에 있는 빨강 상자가 제일 앞에 보여.",
"keys": [
"초록은 가장 뒷줄",
"빨강이 가장 앞에 보인다"
],
...
"small": "02. 쌓은 모양과 쌓기나무의 개수(1)·위에서 본 모양",
"kind": "add",
"q": "쌓은 모양과 위에서 본 모양이 그림과 같아. 위에서 본 모양의 칸 수는 무엇을 알려 줘?",
"round": 1,
"ord": 0,
"answer": "1층에 놓인 쌓기나무의 자리 수를 알려 줘. 5칸이니까 1층에는 5개가 놓여 있어.",
"keys": [
"1층 자리 수를 알려 준다",
"1층에 5개"
],
...
"small": "02. 쌓은 모양과 쌓기나무의 개수(1)·위에서 본 모양",
"kind": "add",
"q": "같은 그림에서 쌓기나무를 모두 8개 썼대. 위에서 본 모양은 5칸인데 8개면 무엇을 알 수 있어?",
"round": 2,
"ord": 1,
"answer": "1층에 5개가 깔리고 나머지 3개는 그 위에 더 쌓였다는 뜻이야.",
"keys": [
"1층에 5개",
"나머지 3개는 위에 쌓였다"
],
...
"small": "02. 쌓은 모양과 쌓기나무의 개수(1)·위에서 본 모양",
"kind": "add",
"q": "친구가 이 모양을 보고 위에서 본 모양이 4칸이니까 쌓기나무도 4개라고 했어. 뭐가 잘못됐는지 찾고, 바른 답도 말해 봐.",
"round": 2,
"ord": 2,
"answer": "위에서 본 모양은 1층 자리만 보여 줘. 위에 더 쌓인 것까지 세면 모두 6개야.",
"keys": [
"위에서 본 모양은 1층 자리만 보여 준다",
"모두 6개"
],
"answerBy": "claude",
"by": "claude"
...
"small": "03. 쌓은 모양과 쌓기나무의 개수(2)·위·앞·옆에서 본 모양",
"kind": "add",
"q": "위·앞·옆에서 본 모양이 그림과 같아. 쌓기나무는 모두 몇 개야?",
"round": 1,
"ord": 0,
"answer": "왼쪽 뒤 자리만 2층이고 나머지 세 자리는 1층이야. 2 + 1 + 1 + 1 = 5개야.",
"keys": [
"자리마다 층수가 하나로 정해진다",
"5개"
],
...
"small": "03. 쌓은 모양과 쌓기나무의 개수(2)·위·앞·옆에서 본 모양",
"kind": "add",
"q": "위·앞·옆에서 본 모양이 그림과 같아. 쌓기나무가 가장 적을 때와 가장 많을 때는 각각 몇 개야?",
"round": 2,
"ord": 1,
"answer": "가장 적을 때는 대각선으로 두 자리만 2층으로 쌓아 2 + 1 + 1 + 2 = 6개, 가장 많을 때는 네 자리를 모두 2층으로 쌓아 8개야.",
"keys": [
"가장 적을 때 6개",
"가장 많을 때 8개"
],
...
"small": "03. 쌓은 모양과 쌓기나무의 개수(2)·위·앞·옆에서 본 모양",
"kind": "add",
"q": "위·앞·옆에서 본 모양이 같아도 쌓은 모양이 여러 가지가 될 수 있는 이유를 말해 봐.",
"round": 2,
"ord": 2,
"answer": "앞이나 옆에서는 각 줄에서 가장 높은 층만 보여. 그래서 뒤에 가려진 자리의 층수는 여러 가지가 될 수 있어.",
"keys": [
"가장 높은 층만 보인다",
"가려진 자리는 여러 가지가 된다"
],
...
"small": "04. 쌓은 모양과 쌓기나무의 개수(3)·위에서 본 모양에 수 쓰기",
"kind": "add",
"q": "위에서 본 모양에 수가 그림처럼 쓰여 있어. 쌓기나무는 모두 몇 개야?",
"round": 1,
"ord": 0,
"answer": "쓰인 수를 모두 더하면 돼. 3 + 1 + 2 + 1 = 7개야.",
"keys": [
"수를 모두 더한다",
"7개"
],
...
"small": "04. 쌓은 모양과 쌓기나무의 개수(3)·위에서 본 모양에 수 쓰기",
"kind": "add",
"q": "같은 그림의 모양을 앞에서 보면 각 줄이 몇 층으로 보여?",
"round": 2,
"ord": 1,
"answer": "각 줄에서 가장 높은 층만 보이니까 왼쪽부터 3층, 1층, 2층으로 보여.",
"keys": [
"각 줄의 가장 높은 층",
"3층 · 1층 · 2층"
],
...
"small": "04. 쌓은 모양과 쌓기나무의 개수(3)·위에서 본 모양에 수 쓰기",
"kind": "add",
"q": "친구가 이 그림을 보고 가장 큰 수 3이 쌓기나무 전체 개수라고 했어. 뭐가 잘못됐는지 찾고, 바른 답도 말해 봐.",
"round": 2,
"ord": 2,
"answer": "3은 한 자리에 쌓은 개수일 뿐이야. 모든 자리의 수를 더해야 해서 1 + 3 + 2 + 2 + 1 = 9개야.",
"keys": [
"3은 한 자리의 개수",
"모두 더하면 9개"
],
...
"small": "05. 쌓은 모양과 쌓기나무의 개수(4)·층별로 나타낸 모양",
"kind": "add",
"q": "층별로 나타낸 모양이 그림과 같아. 쌓기나무는 모두 몇 개야?",
"round": 1,
"ord": 0,
"answer": "각 층의 칸 수를 더하면 돼. 4 + 2 + 1 = 7개야.",
"keys": [
"각 층의 칸 수를 더한다",
"7개"
],
...
"small": "05. 쌓은 모양과 쌓기나무의 개수(4)·층별로 나타낸 모양",
"kind": "add",
"q": "쌓은 모양과 1층 모양이 그림과 같아. 2층과 3층 모양은 각각 몇 칸이야?",
"round": 2,
"ord": 1,
"answer": "2층까지 쌓인 자리가 2곳이라 2층은 2칸, 3층까지 쌓인 자리가 1곳이라 3층은 1칸이야.",
"keys": [
"2층은 2칸",
"3층은 1칸"
],
...
"small": "06. 여러 가지 모양을 만들어 볼까요",
"kind": "add",
"q": "㉠과 ㉡은 서로 다른 모양이야? 왜 그런지 말해 봐.",
"round": 1,
"ord": 0,
"answer": "서로 달라. ㉠은 한 줄로 놓인 3개의 끝 위에 1개를 얹었고, ㉡은 2개 옆에 1개를 앞으로 붙이고 위로도 1개를 붙였어. 돌리거나 뒤집어도 겹치지 않아.",
"keys": [
"서로 다른 모양",
"돌리거나 뒤집어도 겹치지 않는다"
],
...
"small": "06. 여러 가지 모양을 만들어 볼까요",
"kind": "add",
"q": "쌓기나무 64개로 큰 정육면체를 만들고 겉면 전체에 페인트를 칠한 다음 다시 떼어 놓았어. 페인트가 한 면도 묻지 않은 쌓기나무는 몇 개야?",
"round": 2,
"ord": 1,
"answer": "64 = 4 × 4 × 4라 한 모서리에 4개씩 있어. 겉을 한 겹 벗기면 안쪽에 2 × 2 × 2가 남으니까 8개야.",
"keys": [
"한 모서리에 4개",
"안쪽 2 × 2 × 2 = 8개"
],
...
"small": "06. 여러 가지 모양을 만들어 볼까요",
"kind": "add",
"q": "같은 정육면체에서 세 면에 페인트가 묻은 쌓기나무는 몇 개이고, 어디에 있는 것들이야?",
"round": 2,
"ord": 2,
"answer": "정육면체의 꼭짓점 자리에 있는 것들이야. 꼭짓점이 8개니까 8개야.",
"keys": [
"꼭짓점 자리",
"8개"
],
