...
GROUPS = [
    ('E1', ['01. 다항식의 연산(1)','02. 다항식의 연산(2)','03. 다항식의 연산(3)','04. 항등식과 나머지정리(1)','05. 항등식과 나머지정리(2)','06. 인수분해(1)','07. 인수분해(2)']),
    ('E2', ['08. 복소수(1)','09. 복소수(2)','10. 복소수(3)','11. 이차방정식(1)','12. 이차방정식(2)','13. 이차방정식(3)','14. 이차방정식(4)']),
    ('E3', ['15. 이차방정식과 이차함수(1)','16. 이차방정식과 이차함수(2)','17. 삼차방정식과 사차방정식(1)','18. 삼차방정식과 사차방정식(2)']),
    ('E4', ['19. 연립방정식(1)','20. 연립방정식(2)','21. 일차부등식','22. 이차부등식(1)','23. 이차부등식(2)']),
    ('E5', ['24. 경우의 수','25. 순열(1)','26. 순열(2)','27. 조합(1)','28. 조합(2)']),
    ('E6', ['29. 행렬과 그 연산(1)','30. 행렬과 그 연산(2)']),
]
GROUPS_OLD = [
    ('D1', ['1. 평면좌표', '2. 직선의 방정식']),
